...
# what is the range of the data? (max and min)
...
cl <- colorRampPalette(c('darkmagenta','orange','yellow'))(100) # 
...
rlist <- list.files(pattern="EN") #explains to the software what files we want #pattern: common part of the name
rlist
